    ...
    return Promise.all([
      ...
      return Promise.all([
        ...
        knex('azul_actions').insert([
          {id: 1, game_id: 1, round_number: 1, turn_number: null, type: 'FACTORY_REFILL', params: JSON.stringify({factoryIndex: 0, factoryCode: '0121'})},
          {id: 2, game_id: 1, round_number: 1, turn_number: null, type: 'FACTORY_REFILL', params: JSON.stringify({factoryIndex: 1, factoryCode: '3410'})},
          {id: 3, game_id: 1, round_number: 1, turn_number: null, type: 'FACTORY_REFILL', params: JSON.stringify({factoryIndex: 2, factoryCode: '2113'})},
          {id: 4, game_id: 1, round_number: 1, turn_number: null, type: 'FACTORY_REFILL', params: JSON.stringify({factoryIndex: 3, factoryCode: '4410'})},
          {id: 5, game_id: 1, round_number: 1, turn_number: null, type: 'FACTORY_REFILL', params: JSON.stringify({factoryIndex: 4, factoryCode: '0023'})},
